...
// --max-turns caps a runaway run. The workflow supplies CLAUDE_CODE_OAUTH_TOKEN,
// so the spend is subscription quota rather than API billing; the cap matters either way.
